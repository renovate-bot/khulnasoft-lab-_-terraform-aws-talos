...
module "talos" {
  source = "git::https://github.com/khulnasoft-lab/terraform-aws-talos?ref=<RELEASE_TAG>"
  ...
  region             = "eu-west-1"
  tags               = local.tags
  // VPC needs to be created in advance via https://github.com/khulnasoft-lab/terraform-aws-vpc
